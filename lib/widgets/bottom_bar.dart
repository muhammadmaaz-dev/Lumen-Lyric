...
class SongOptionsWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isLiked = favorites.contains(songId);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // 4. List Options
          _buildListTile(Icons.library_add_check_outlined, "Add to library"),
              ...
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  actions: [
                    ...
                    TextButton(
                      onPressed: () {
                        // 1. Provider call karke delete karo
                        ref
                            .read(songsProvider.notifier)
                            .deleteSong(songId, filePath);
  ...
  // FIX: Yahan 'onTap' parameter add kiya hai
  Widget _buildListTile(
    IconData icon,
    String title, {
    Color iconColor = Colors.grey,
    Color textColor = Colors.white,
    VoidCallback? onTap, // <--- YE ADD KIYA HAI
  }) {
    return ListTile(
