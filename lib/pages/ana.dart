...
class YtDownloadService {
  ...
  // ... (isApiOnline, wakeUpServer, isValidYoutubeUrl, getMetadata SAME AS BEFORE) ...
  // Copy paste karein purana code yahan tak...

  // (Yeh wale functions change nahi huye, sirf downloadAudio update hua hai)
  ...
  Exception _handleDioError(DioException e) {
    switch (e.type) {
      ...
      case DioExceptionType.receiveTimeout:
        return Exception(
          'Connection timed out. Server is waking up, try again.',
        );
      case DioExceptionType.connectionError:
        return Exception('Cannot connect to server. Check internet.');
      case DioExceptionType.badResponse:
        final detail = e.response?.data?['detail'];
        return Exception(detail ?? 'Server error. Please try again.');
